...
const DeleteBook = () => {
  ...
  const handleDeleteBook = () => {
    setLoading(true);
    axios
      .delete(`https://book-store-ei1l.onrender.com/books/${id}`)
      .then(() => {
        setLoading(false);
  ...
  return (
    <div className='p-4'>
      ...
      <div className='flex flex-col items-center border-2 border-sky-400 rounded-xl w-full max-w-lg p-8 mx-auto'>
        ...
        <button
          className='p-4 bg-red-600 text-white rounded hover:bg-red-500 transition duration-200 ease-in-out w-full'
